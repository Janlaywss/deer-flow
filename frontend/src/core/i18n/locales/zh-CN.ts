...
export const zhCN: Translations = {
  ...
  knowledge: {
    title: "知识库",
    description: "管理 Viking 知识库中的知识文件。",
    refresh: "刷新",
    upload: "上传",
    uploading: "上传中...",
    uploadSuccess: "知识已提交上传",
    deleteSuccess: "知识已删除",
    selectCollection: "选择知识库",
    docCount: (count: number) => `${count} 条知识`,
    docName: "知识名称",
    docNamePlaceholder: "默认使用文件名",
    docNameValidationHint:
      "仅支持中文、英文字母、数字、下划线、连字符和英文句点，不能包含空格或特殊字符。",
    docNameValidationError:
      "知识名称不能包含空格或特殊字符，仅支持中文、英文字母、数字、下划线、连字符和英文句点。",
    docType: "类型",
    docStatus: "文档状态",
    docStatusReady: "已完成",
    docStatusQueued: "排队中",
    docStatusUpdating: "更新中",
    docStatusDeleting: "删除中",
    docStatusProcessing: "处理中",
    docStatusFailed: "处理失败",
    docStatusUnknown: "未知",
    docIdOptional: "知识 ID（可选）",
    docIdPlaceholder: "留空自动生成，仅支持字母、数字、下划线",
    file: "文件",
    fileValidationHint: "仅支持上传 PDF 文件。",
    fileValidationError: "知识库仅支持上传 PDF 文件。",
    fileSize: "文件大小",
    points: "分段",
    summary: "摘要",
    source: "来源",
    ...
    descriptionPlaceholder: "添加知识说明",
    maxUploadSize: (size: string) => `最大 ${size}`,
    uploadDescription: (collection: string) => `上传文件到 ${collection}`,
    deleteConfirm: (name: string) =>
      `确定删除知识“${name}”吗？此操作不可撤销。`,
    accessDeniedTitle: "需要管理员权限",
    accessDeniedDescription: "只有 DeerFlow 管理员可以查看知识库。",
    unavailableTitle: "知识库不可用",
    notConfiguredTitle: "Viking 知识库未配置",
    notConfiguredDescription:
      "请在后端环境变量中设置 VIKINGDB_API_KEY，或设置 VIKINGDB_ACCESS_KEY_ID 与 VIKINGDB_SECRET_ACCESS_KEY。",
    uploadNotConfiguredTitle: "文件上传未配置",
    uploadNotConfiguredDescription:
      "本地文件上传需要先配置 VIKINGDB_TOS_BUCKET，以及 VIKINGDB_ACCESS_KEY_ID 与 VIKINGDB_SECRET_ACCESS_KEY。",
    configLoadErrorTitle: "无法读取知识库配置",
    configLoadErrorDescription: "请刷新页面或稍后重试。",
    loadCollectionsErrorTitle: "无法加载知识库列表",
    loadCollectionsErrorDescription: "请检查 Viking 配置后重试。",
    loadDocsErrorTitle: "无法加载知识列表",
    loadDocsErrorDescription: "请刷新页面或稍后重试。",
    loadDocErrorTitle: "无法加载知识详情",
    loadDocErrorDescription: "请稍后重试。",
    emptyCollectionsTitle: "还没有知识库",
    emptyCollectionsDescription: "Viking 知识库会显示在这里。",
    emptyDocsTitle: "还没有知识",
    emptyDocsDescription: "上传文件后，知识会显示在这里。",
  },
